...
from . import rec_all_viewed as rec
from .. import utils
...
def main(data_path):
    ...
    subm_csv = data_directory.joinpath('submission_all_viewed2.csv')
    ...
    subm_csv_local = data_directory.joinpath('submission_all_viewed2_local.csv')
