...
from . import rec_all_viewed_last_booked as rec
from .. import utils
...
def main(data_path):
    ...
    subm_csv = data_directory.joinpath('submission_all_viewed_last_booked.csv')
    ...
    subm_csv_local = data_directory.joinpath('submission_all_viewed_last_booked_local.csv')
