...
from . import rec_all_viewed_combined_features as rec
from .. import utils
...
def main(data_path):
    ...
    subm_csv = data_directory.joinpath('submission_all_viewed_combined_features.csv')
    ...
    subm_csv_local = data_directory.joinpath('submission_all_viewed_combined_features_local.csv')
