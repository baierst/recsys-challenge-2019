...
from . import rec_most_hotel as rec
from .. import utils
...
def main(data_path):
    ...
    subm_csv = data_directory.joinpath('submission_most_hotel.csv')
    ...
    subm_csv_local = data_directory.joinpath('submission_most_hotel_local.csv')
